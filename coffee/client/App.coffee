class App
  ###
    The most important class in frontend
    Initialize the game scene, canvas and players
  ###
  ...
  update:()=>
    ###
      Update the game elements according to user actions
    ###
  ...
  getMouseWorldPosition:()=>
    ###
      Calculate the mouse postioin by the screen position and camera
    ###
    res=
